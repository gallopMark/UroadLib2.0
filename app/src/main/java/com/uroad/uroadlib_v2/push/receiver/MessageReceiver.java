package com.uroad.uroadlib_v2.push.receiver;
...
import com.uroad.uroadlib_v2.push.bean.XGNotification;
        ...
        if (customContent != null && customContent.length() != 0) {
            try {
                ...
                if (!obj.isNull("title")) {
                    ...
                    Log.d(LogTag, "get custom value:" + title);
                }
                if (!obj.isNull("content")) {
                    String content = obj.getString("content");
                    Log.d(LogTag, "get custom value:" + content);
                }
