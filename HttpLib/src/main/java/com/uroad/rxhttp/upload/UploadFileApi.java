...
public interface UploadFileApi {
    ...
    @Multipart
    @POST
    Observable<ResponseBody> uploadFileWithJson(@Url String url, @Part MultipartBody.Part part, @Body JsonObject json);
    ...
    @Multipart
    @POST
    Observable<ResponseBody> uploadFilesWithJson(@Url String url, @Part List<MultipartBody.Part> parts, @Body JsonObject json);
}
